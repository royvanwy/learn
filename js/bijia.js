...
$(function(){
    ...
    setproducttitle($('.product-list-title'), $.getUrlParam('productid'));
    setbijiproduct($('.product-bijia'), $.getUrlParam('productid'));
    setproductcom($('.product-com-list'), $.getUrlParam('productid'))

     function setbijiproduct(dom,productid,callback){
    ...
    function setproductcom(dom, productid, callback) {
        productid = productid || 0;
    ...
    function setproducttitle(dom,productid,callback){
        productid=productid||0;
        Route.getproduct(productid,function(res){
